...
public class BottomDialog extends Dialog implements OnClickListener, OnItemClickListener {
     ...
     * @param names          菜单项名称
     */
    public BottomDialog(Activity activity, SelectDialogListener listener, SelectDialogCancelListener cancelListener, List<String> names) {
        super(activity, R.style.transparentFrameWindowStyle);
        mActivity = activity;
        mListener = listener;
     ...
     * @param title    菜单标题文字
     */
    public BottomDialog(Activity activity, SelectDialogListener listener, List<String> names, String title) {
        super(activity, R.style.transparentFrameWindowStyle);
        mActivity = activity;
        mListener = listener;
        this.mName = names;
    ...
    public BottomDialog(Activity activity, SelectDialogListener listener, SelectDialogCancelListener cancelListener, List<String> names, String title) {
        super(activity, R.style.transparentFrameWindowStyle);
        mActivity = activity;
        mListener = listener;
        mCancelListener = cancelListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.view_dialog_bottom, null);
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (1 == mStrings.size()) {
                ...
                viewholder.dialogItemButton.setTextColor(mFirstItemColor);
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.bottom_dialog_item_bg_top);
            } else if (position == mStrings.size() - 1) {
                viewholder.dialogItemButton.setTextColor(mOtherItemColor);
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.bottom_dialog_item_bg_buttom);
            } else {
                viewholder.dialogItemButton.setTextColor(mOtherItemColor);
                viewholder.dialogItemButton.setBackgroundResource(R.drawable.bottom_dialog_item_bg_center);
            }
            return convertView;
        }
